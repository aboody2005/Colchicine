...
// Draw connections between nearby particles (desktop only, throttled)
const DRAW_CONNECTIONS = window.innerWidth >= 768;
...
function animateParticles() {
  ...
  // Only draw connections every 2 frames to halve connection-draw cost
  if (animFrame % 2 === 0) drawConnections();
...
// ========= HERO SUBTITLE — no JS delay needed, CSS heroFadeIn handles it =========
...
setInterval(createFloatingMolecule, 2500);
